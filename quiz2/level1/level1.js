...
//여기서는 코드를 어떻게 실행시켜야 할지 생각이 빨리 안된다ㅠㅜ for문이 약한것 같다..
6. 대충 생각을 해보면 
.....몇개를 쪼개야하는지를 인자로 받아와 코드를 짜야 하는데, 이부분에서 조금 막힙니다.. 
*/
...
//구글링을 해보니 slice는 end 값이 배열의 길이보다 크다면 배열의 끝까지 추출한다 라고 되어있다.
//그러니 배열의 길이가 홀수여도 다 쪼개고 남은 배열이 마저 반환 된다는 뜻인것같다.
